...
function GetStudents() {
    var promise = new Promise(function (resolve, reject) {
        var url = _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getbytitle('CurrentStudentInfo')/items?$top=5000&$filter=School_x0020_District eq '" + Shp.Page.GetParameterFromUrl('School') + "' and Active eq 1";
