...
<asp:ScriptReference Path="StaffAddStudent.js" />
</Scripts>
...
<div class="form-group">
	...
	<SharePoint:DVDropDownList required="required" ID="school" DataSourceID="DSSChools" DataTextField="District_x002d_School" DataValueField="District_x002d_School" AppendDataBoundItems="true" ClientIDMode="Static" runat="server" CssClass="form-control input-sm" onchange="javascript:SetSchool()">
...
<div class="form-group">
	<div class="col-lg-12">
		<label>School</label>
		<select required="required" class="form-control input-sm" id="smallthendistict">
...
<div class="form-group">
	...
	<input type="text" id="firstName" required="required" class="form-control input-sm" />	 
	</div>
	<div class="col-lg-6">
	<label>Last Name</label>
	<input type="text" id="lastName" required="required" class="form-control input-sm" />	 
	</div>
</div>
...
<div class="form-group">
	<div class="col-lg-6">
	<label>State</label>
	<input type="text" id="state" class="form-control input-sm" required="required" />	 
	</div>
	<div class="col-lg-6">
	<label>City</label>
	<input type="text" id="city" class="form-control input-sm" required="required" />	 
	</div>
</div>
...
<div class="form-group">
	...
	<input type="text" id="zip" class="form-control input-sm" required="required" />	 
	</div>
	<div class="col-lg-6">
	<label>Street Address</label>
	<input type="text" id="streetAddress" class="form-control input-sm" required="required" />	 
	</div>
</div>
